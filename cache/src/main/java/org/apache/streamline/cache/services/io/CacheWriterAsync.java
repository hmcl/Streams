...
public class CacheWriterAsync<K, V> implements CacheWriter<K, V> {
    ...
    private final CacheWriter<K, V> dataStoreWriter;
    private ExecutorService executorService;

    public CacheWriterAsync(CacheWriter<K, V> dataStoreWriter) {
        this(dataStoreWriter, Executors.newFixedThreadPool(DEFAULT_NUM_THREADS));
    }

    public CacheWriterAsync(CacheWriter<K, V> dataStoreWriter, ExecutorService executorService) {
