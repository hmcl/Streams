...
public enum CacheManagerLocalRegistry implements CacheManagerRegistry {
    INSTANCE;

    private static final Logger LOG = LoggerFactory.getLogger(CacheManagerLocalRegistry.class);

    private final ConcurrentMap<CacheServiceId, CacheService<?,?>> serviceIdToService;

    CacheManagerLocalRegistry() {
