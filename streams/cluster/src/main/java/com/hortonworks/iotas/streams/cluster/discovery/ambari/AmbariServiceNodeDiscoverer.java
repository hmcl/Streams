...
public class AmbariServiceNodeDiscoverer implements ServiceNodeDiscoverer {
  ...
  // TODO: Is it too open? Or it is fine to have password as immutable String in memory?
  ...
  @Override public void init(Map<String, String> conf) throws ConfigException {
    // no op
  }
